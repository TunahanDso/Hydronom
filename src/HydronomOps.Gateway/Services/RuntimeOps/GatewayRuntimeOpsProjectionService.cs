...
/// <summary>
/// Gateway'in tuttuğu aggregate state'i Hydronom Ops tarafından tüketilebilir
/// runtime telemetry ve diagnostics DTO'larına dönüştürür.
/// </summary>
public sealed class GatewayRuntimeOpsProjectionService : IGatewayRuntimeOpsProjectionService
{
    public GatewayRuntimeTelemetrySummaryDto BuildTelemetrySummary(VehicleAggregateState state)
    {
    ...
    public GatewayRuntimeDiagnosticsDto BuildDiagnostics(VehicleAggregateState state)
    {
        ArgumentNullException.ThrowIfNull(state);
