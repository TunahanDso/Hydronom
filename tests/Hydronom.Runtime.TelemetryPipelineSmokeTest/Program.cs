...
Console.WriteLine($"CapabilityCount       : {summary1.CapabilityCount}");
Console.WriteLine($"AvailableCapabilities : {summary1.AvailableCapabilityCount}");
Console.WriteLine($"DegradedCapabilities  : {summary1.DegradedCapabilityCount}");
Console.WriteLine($"MissingCapabilities   : {summary1.MissingCapabilityCount}");
Console.WriteLine($"HasGlobalPosition     : {summary1.HasGlobalPositionCapability}");
Console.WriteLine($"HasLocalPosition      : {summary1.HasLocalPositionCapability}");
Console.WriteLine($"HasAttitude           : {summary1.HasAttitudeCapability}");
Console.WriteLine($"HasDepth              : {summary1.HasDepthCapability}");
Console.WriteLine($"CapabilitySummary     : {summary1.CapabilitySummary}");
...
Require(summary1.CapabilityCount > 0, "Summary #1 capability count 0'dan büyük olmalı.");
Require(summary1.AvailableCapabilityCount >= 2, "Summary #1 en az GPS/IMU capability'leri available olmalı.");
Require(summary1.HasGlobalPositionCapability, "Summary #1 global_position capability true olmalı.");
Require(summary1.HasLocalPositionCapability, "Summary #1 local_position capability true olmalı.");
Require(summary1.HasAttitudeCapability, "Summary #1 attitude capability true olmalı.");
Require(!summary1.HasDepthCapability, "Summary #1 depth capability false olmalı çünkü bu testte depth sensör kapalı.");
Require(summary1.CapabilitySummary.Contains("global_position", StringComparison.OrdinalIgnoreCase), "Summary #1 capability summary global_position içermeli.");
Require(summary1.CapabilitySummary.Contains("attitude", StringComparison.OrdinalIgnoreCase), "Summary #1 capability summary attitude bilgisini içermeli.");
...
Console.WriteLine($"CapabilitySummary     : {summary2.CapabilitySummary}");
Console.WriteLine($"HasGlobalPosition     : {summary2.HasGlobalPositionCapability}");
Console.WriteLine($"HasLocalPosition      : {summary2.HasLocalPositionCapability}");
Console.WriteLine($"HasAttitude           : {summary2.HasAttitudeCapability}");
Console.WriteLine($"HasDepth              : {summary2.HasDepthCapability}");
...
Require(summary2.HasGlobalPositionCapability, "Summary #2 global_position capability true kalmalı.");
Require(summary2.HasLocalPositionCapability, "Summary #2 local_position capability true kalmalı.");
Require(summary2.HasAttitudeCapability, "Summary #2 attitude capability true kalmalı.");
Require(!summary2.HasDepthCapability, "Summary #2 depth capability false kalmalı çünkü bu testte depth sensör kapalı.");
...
Console.WriteLine("PASS: RuntimeTelemetryPipeline gerçek CSharpSensorRuntime + CDSE + FusionRuntimeHost + RuntimeTelemetryHost + capability telemetry zincirini doğru çalıştırdı.");
Console.ResetColor();
